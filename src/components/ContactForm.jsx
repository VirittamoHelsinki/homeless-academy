...
import { contactformText } from '../utils/contactformText'
      ...
      <dialog id='my_modal_1' className='modal' onClick={(e) => e.target.close()}>
        <div className='modal-box bg-light-green prose flex flex-col lg:flex-row gap-6 max-w-5xl'>
            <div className='flex-1'>
              <h1>{contactformText.title[language]}</h1>
              <h3>{contactformText.description[language]}</h3>
              <p>{contactformText.prompt[language]}</p>
            </div>
            <div className='flex-1'>
              <form className='flex flex-col' onSubmit={handleSubmit}>
                <input className='border-b border-dark-gray mb-6 p-4 bg-inherit placeholder-dark-gray outline-none' placeholder={contactformText.emailField[language]} />
                <input className='border-b border-dark-gray mb-6 p-4 bg-inherit placeholder-dark-gray outline-none' placeholder={contactformText.nameField[language]} />
                <textarea className='border-b border-dark-gray mb-6 px-4 pt-4 bg-inherit placeholder-dark-gray outline-none' placeholder={contactformText.messageField[language]} />
                <button type='submit' className='btn bg-inherit border-dark-gray rounded-3xl hover:bg-blue mt-6 w-32'>{contactformText.button[language]}</button>
              </form>
