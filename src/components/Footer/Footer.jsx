  ...
  return (
    <div>
      <footer className="footer  items-center p-10 bg-neutral text-white">
        <div className="flex  flex-row-reverse gap-x-40 items-center lg:hidden">
          <button className="border border-white  text-white px-6 py-1 ">Contact us</button>
        ...
        <aside className="items-center grid lg:grid-flow-row ">
          <div className=' hidden lg:flex  lg:items-center gap-4'>
            <div>
              <img className="h-12 w-10" src={img} alt="logo" />
            </div>
          ...
          <nav className="grid grid-flow-col   gap-2 lg:gap-8 lg:gap-12 pt-2 lg:pt-8 pb-8" >
          ...
          <p className=' pb-2 lg:pb-8'>Y-tunnus: 2289677-6</p>
          <div className="lg:grid lg:grid-flow-col gap-4" >
            <p className='pb-2'>@ Homeless Academy 2023</p>
            <p>Terms-privecy</p>

          </div>
        </aside>
        {/* contact part */}
        <div className=" hidden lg:flex lg:flex-col lg:gap-8 lg:place-self-start lg:justify-self-end lg:items-end">
        ...
        <div className=' lg:hidden flex  items-center gap-2'>
          <div>
            <img className="h-12 w-8" src={img} alt="logo" />
          </div>
          <div className='flex flex-col'>
            <p className=' font-semibold text-xl text-white font-lexend pb-1'
              style={{ borderBottomWidth: '1px', borderBottomColor: '#3983C0' }}>Homeless Academy <br></br></p>
            <p className='text-center text-sky-600 text-base font-bold pt-1 '>DESIRE TO CHANGE</p>
          </div>
        </div>
      </footer>
