        ...
        {testimonials.map((testimonial, index) => (
          <div key={index} className="card h-56 bg-white shadow-2xl relative pb-10 mb-10">
            <div className='card-body'>
              <h2 className="text-center font-lexend font-bold p-3">{testimonial.title}</h2>
            ...
            <div className='info-section flex flex-col items-center  '>
              <img src={testimonial.profilePicture.fields.file.url} className='w-10 h-10 rounded-full' alt={`Profile ${index}`} />
