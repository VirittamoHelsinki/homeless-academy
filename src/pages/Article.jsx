...
function Article() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        console.log(
          "Error fetching individual article from Contentful:",
          error
        );
      }
    }
  ...
  return (
    <div className="mt-5 mb-10 mx-12 max-w-7xl">
      {article && (
        <div>
          <div className="object-cover md:w-[49%] xl:w-[32%]">
            <figure>
              <img
          ...
          <h1 className="font-lexend font-extrabold text-2xl lg:text-4xl mb-3">
            {article.title}
          </h1>
          <h3 className="mb-4 text-light-gray font-semibold">
